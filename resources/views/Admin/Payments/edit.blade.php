...
<form action="" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="text" name="name_bank" class="form-control" value="{{$payment->name_bank}}">
    </div>
    
    <div class="form-group">
        <label>Bank Number</label>
        <input type="number" name="bank_number" class="form-control" value="{{$payment->bank_number}}">
    </div>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            <div class="custom-file col-3">
                ...
                <input type="hidden" name = "thumb" id = "file" value="{{$payment->thumb}}">
            </div>
        </div>
        <img id="pic" height="100" src="{{$payment->thumb}}">
    </div>

    <div class="mt-3">
        <div class="custom-control custom-radio">
            <input type="radio" id="customRadio1" name="active" class="custom-control-input" value="0" {!! $payment->active == 0 ? 'checked' : '' !!}>
            <label class="custom-control-label" for="customRadio1" >Yes</label>
        </div>
        <div class="custom-control custom-radio">
            <input type="radio" id="customRadio2" name="active" class="custom-control-input" checked="checked" value= "1" {!! $payment->active == 1 ? 'checked' : '' !!}>
